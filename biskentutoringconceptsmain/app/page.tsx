...
export default function HomePage() {
  ...
  const testimonials = [
    ...
    {
      name: "Parent (UK)",
      text: "The teacher helped my daughter blend words and break them down into syllables. Her writing is now eligible.",
      role: "Parent from UK",
    },
    {
      name: "Dr Bim",
  ...
  return (
    <div className="min-h-screen bg-background">
          ...
          <div className="grid lg:grid-cols-2 gap-8 items-center">
            <div className={`space-y-6 ${isVisible ? "animate-slide-in-left" : "opacity-0"}`}>
              ...
              <div className="flex items-center gap-4 pt-4">
                ...
                <p className="text-sm text-muted-foreground">Trusted by 500+ families</p>
              </div>
            </div>
        ...
        >
          ...
          >
            ...
            <div className="mt-6 flex gap-3">
              ...
              <Button variant="outline" className="flex-1 bg-transparent" onClick={() => setSelectedService(null)}>
      ...
      <section id="about" className="py-16 px-4 bg-card overflow-hidden">
        <div className="container mx-auto max-w-6xl">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="space-y-6 scroll-animate-right">
              <h2 className="text-3xl lg:text-4xl font-bold">Special Care for Every Child</h2>
              <p className="text-lg text-muted-foreground">
                We also deal with <strong>ADHD children</strong>. Our teachers are committed to ensure that your child
                learning experience are filled with the empathy they need to succeed.
              </p>
              ...
              <div className="space-y-4">
                <div className="flex items-center gap-3">
                  ...
                  <span className="text-lg">
                    We touch the <strong>head</strong> (intellect)
                  </span>
                </div>
                <div className="flex items-center gap-3">
                  <div className="bg-primary/10 p-2 rounded-full">
                  ...
                  <span className="text-lg">
                    We touch the <strong>heart</strong> (emotions)
                  </span>
                </div>
                <div className="flex items-center gap-3">
                  <div className="bg-primary/10 p-2 rounded-full">
                  ...
                  <span className="text-lg">
                    We touch the <strong>hand</strong> (practical skills)
                  </span>
                </div>
              </div>
            </div>
      ...
      <section id="testimonials" className="py-8 px-4 bg-muted/20">
        <div className="container mx-auto max-w-6xl">
          ...
          <div className="testimonial-container relative">
            <div
              ref={testimonialRef}
              className="testimonial-scroll flex gap-4 animate-scroll-infinite hover:animation-play-state-paused"
            >
              {/* First set of testimonials */}
              {testimonials.map((testimonial, index) => (
                <Card
                  key={`first-${index}`}
                  className="testimonial-card flex-shrink-0 bg-card hover:shadow-lg transition-all duration-300 hover:-translate-y-2"
                >
                  <CardContent className="card-content p-4 h-full flex flex-col justify-between">
                    <div className="flex items-start gap-3 mb-2">
                      <div className="bg-primary/10 p-2 rounded-full flex-shrink-0">
                        <Star className="h-4 w-4 text-primary fill-current" />
                      </div>
                      <div className="min-w-0 flex-1">
                        <h4 className="font-semibold text-sm leading-tight">{testimonial.name}</h4>
          ...
          <div className="flex flex-col lg:flex-row gap-8 lg:gap-12 items-center lg:items-stretch">
            ...
            <div className="flex-shrink-0">
              <img
                ...
                className="w-48 h-48 lg:w-64 lg:h-64 rounded-2xl object-cover shadow-2xl"
              />
            </div>

            {/* Content Section - All beside the image with proper constraints */}
            <div className="flex-1 text-center lg:text-left space-y-6 lg:max-w-md">
              <div>
                <h2 className="text-2xl lg:text-3xl font-bold mb-2">Ready to Get Started?</h2>
                <h3 className="text-xl lg:text-2xl font-bold mb-2">Bisilola Ajala</h3>
                <p className="text-base lg:text-lg opacity-90 mb-3">BSc Ed | M.Ed | TRCN Certified</p>
                ...
                <p className="text-lg mb-6 opacity-90">Contact Bisilola Ajala today</p>
              </div>
              ...
              <div className="space-y-3">
                <div className="flex flex-col sm:flex-row gap-2">
                  <a
                    ...
                    className="flex items-center justify-center gap-2 bg-white/20 hover:bg-white/30 p-3 rounded-lg transition-all duration-300 text-sm lg:text-base text-white flex-1"
                  >
                  ...
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="flex items-center justify-center gap-2 bg-green-500 hover:bg-green-600 p-3 rounded-lg transition-all duration-300 text-sm lg:text-base flex-1"
                  >
                ...
                <div className="flex items-center gap-2">
                  <a
                    ...
                    className="flex items-center justify-center gap-2 bg-white/20 hover:bg-white/30 p-3 rounded-lg transition-all duration-300 text-white flex-1"
                  >
                  ...
                  <button
                    ...
                    className="bg-white/20 hover:bg-white/30 p-3 rounded-lg transition-all duration-300 text-white"
                    title="Copy email"
                  >
